...
class CrudGUI:
    def __init__(self, master, cust):
        ...
        self.quit_button = tkinter.Button(self.bottom_frame, text='Save & QUIT', command=self.save)
...
class AddGUI:
    def __init__(self, master, add_cust):
        ...
        self.info_label = tkinter.Label(self.middle_frame, text='Add Name')
        self.info_entry = tkinter.Entry(self.middle_frame, widht=15)
    ...
    def add(self):
        ...
        if name not in self.customer_list:
            ...
            tkinter.messagebox.showinfo('Name is already in the list')
...
class ChangeGUI:
    def __init__(self, master, change_cust):
        ...
        self.change.title('Change a customer')
        ...
        # buttons for bottom frame
        self.change_button = tkinter.Button(self.bottom_frame, text='Add', command=self.change)
        self.back_button = tkinter.Button(self.bottom_frame, text='Main Menu', command=self.back)
    ...
    def change(self):
        ...
        info = self.customer_list.get(name, 'Not Found')
        if name not in self.customer_list:
            self.customer_list[name] = info
            self.value.set(info)
            tkinter.messagebox.showinfo('Change', 'Name has been changed')
        else:
            tkinter.messagebox.showinfo('Name has already been changed')
...
class DeleteGUI:
    ...
    def delete(self):
        ...
        if name not in self.customer_list:
            ...
            tkinter.messagebox.showinfo('Deleted', 'Name has been Deleted')
        else:
            tkinter.messagebox.showinfo('Name cannot be deleted')
